...
<div class="vh-100 vw-100 bg-base-dark">
      ...
      <div class="vh-100 vw-100" >
        ...
        <?php  
        $FetchedDataArray = fetch_Package("Operational Level", "");
        foreach($FetchedDataArray as $FetchedDataValue){ 
          ?>     
              <div class="text-center ">
                ...
                <p id="valuedata-<?= $FetchedDataValue['ID'] ?>" class="waittimes-timings text-nowrap font-weight-bold text-capitalize text-center w-100">Loading</p>
              </div>
