      ...
      <div class="vh-100 vw-100" >
        <div id="Content" class="center w-100 ml-3 mr-3 pl-3 pr-3">
              <div class="text-center ">
                <p id="packagedata" class="waittimes-title text-capitalize text-center w-100">CAT 2 Wait Times</p>
                <p id="valuedata" class="waittimes-timings text-nowrap font-weight-bold text-capitalize text-center w-100">Loading</p>
              </div>
        
          <div class="m-0 p-0 footer text-capitalize text-center">
